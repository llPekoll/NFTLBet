<button class="button py-2 px-14">
	<span class="button__text "> <span>b</span><span>u</span>y</span><span /><span>T</span><span
		>i</span
	><span>c</span><span>k</span><span>e</span><span>t</span>

	<svg class="button__svg pl-5" role="presentational" viewBox="0 0 600 600">
		<defs>
			<clipPath id="myClip">
